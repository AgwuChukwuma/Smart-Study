...
export default function LoginPage () {
    const { login, navigate, theme, toggleTheme } = useApp()
            ...
            <main className="auth-main">
                <div className="auth-panel-left">
                    <div className="auth-panel-inner">
                        <div className="auth-brand-badge">AI-powered learning</div>
                        <h2 className="auth-panel-heading">Study smarter,<br />not harder.</h2>
                        <p className="auth-panel-sub">Join thousands of students using Smart Study to ace their exams with AI-generated summaries, quizzes, and progress insights.</p>
                        <div className="auth-stats">
                            <div className="auth-stat"><span className="auth-stat-num">50k+</span><span className="auth-stat-label">Students</span></div>
                            <div className="auth-stat-divider" />
                            <div className="auth-stat"><span className="auth-stat-num">2M+</span><span className="auth-stat-label">Summaries</span></div>
                            <div className="auth-stat-divider" />
                            <div className="auth-stat"><span className="auth-stat-num">98%</span><span className="auth-stat-label">Satisfaction</span></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="auth-panel-right">
                    <div className="auth-card">
                        <div className="auth-card-header">
                            ...
                            <p className="auth-card-sub">Sign in to continue</p>
                        </div>

                        <div className="auth-social-row">
                            <button className="auth-social-btn" type="button" onClick={() => setError("Social login isn't set up yet — please use email and password.")}>
                        ...
                        <form className="auth-form" onSubmit={handleSubmit}>
                            ...
                            <div className="auth-field">
                                ...
                                <div className="auth-input-wrap">
                                    <input type={showPassword ? "text" : "password"} className="auth-input auth-input-icon" placeholder="Enter your password" value={password} onChange={e => setPassword(e.target.value)} />
                        ...
                        <p className="auth-switch">
                            ...
                            <button className="auth-switch-link" onClick={() => navigate("signup")} style={{ background: "none", border: "none", cursor: "pointer", font: "inherit", padding: 0 }}>
                                Create one free
                            </button>
                        </p>
                    </div>
